...
- [22:09](https://www.loom.com/share/b74ed3c77fe74ef4a4fa4fcc2b247699?t=1329): Restarting the kernel and submitting to Pensive
...
- [29:25](https://www.loom.com/share/b74ed3c77fe74ef4a4fa4fcc2b247699?t=1765): Verifying public tests pass on Pensive
...
GitHub in [this Git repository](https://github.com/eecs245/fa26-code). (If you follow Option 2 and use DataHub, the magic links we provide automatically pull from this repository.)
...
\"clone\" the course repository. The command to do this is:
    ...
    git clone https://github.com/eecs245/fa26-code
...
3. `cd` to the directory where your local copy of the course repository is stored. The course repository is called `fa26-code`, so you might run something like `cd Desktop/EECS245/fa26-code` if you made an `EECS245` folder on your Desktop to store course materials.
4. Once you're in `fa26-code`, run `git pull` to get the latest version of the course materials.
...
To submit your Jupyter Notebooks to Pensive, you'll need to first download them to your computer, and then upload them to Pensive.
