---
layout: page
title: "Lab 5: Span, Linear Independence, and Subspaces"
description: "Lab 5: Span, Linear Independence, and Subspaces activities."
nav_exclude: true
hide_footer_hr: true
---
...
# Lab 5: Span, Linear Independence, and Subspaces

**due** by the end of your lab section on Wednesday, September 30th, 2026
...
{: .yellow }
<div markdown="1">
Each lab worksheet will contain several activities, some of which will involve writing code and others that will involve writing math on paper. To receive credit for a lab, you must complete Activities 1-4 and show your lab TA by the end of the lab section.
...
- [Activity 3: Finding a Linearly Independent Subset](#activity-3-finding-a-linearly-independent-subset)
- [Activity 4: Finding Bases for Subspaces](#activity-4-finding-bases-for-subspaces)
- [Activity 5: Introduction to Subspaces](#activity-5-introduction-to-subspaces)
- [Activity 6: Finding Non-Examples of Subspaces](#activity-6-finding-non-examples-of-subspaces)

---

## Recap: Span, Linear Independence, Subspaces, Bases, and Dimension

<ul class="assignment-list" markdown="1" data-item-count="6">
<li markdown="1">

([Chapter 4.1](https://notes.eecs245.org/linear-independence/span/)) The **span** of a set of vectors is the set of all possible linear combinations of the vectors in the set.
...
([Chapter 4.2](https://notes.eecs245.org/linear-independence/linear-independence/)) Intuitively, a set is **linearly independent** if none of the vectors in the set is a redundant building block: you can't create it from the other vectors.

Formally, <span class="math-inline">\\(\vec v&#95;1, \vec v&#95;2, \ldots, \vec v&#95;d\\)</span> are **linearly independent** if the only solution to

<div class="math-display">
$$
a_1 \vec v_1 + a_2 \vec v_2 + \cdots + a_d \vec v_d = \vec 0
$$
</div>

 is <span class="math-inline">\\(a&#95;1 = a&#95;2 = \cdots = a&#95;d = 0\\)</span>. If a set of vectors is not linearly independent, it is **linearly dependent**.

</li>
<li markdown="1">

([Chapter 4.3](https://notes.eecs245.org/linear-independence/vector-spaces-basis-dimension/)) A **subspace** <span class="math-inline">\\(S\\)</span> of a vector space <span class="math-inline">\\(V\\)</span> is a set of vectors where:

<ol class="assignment-list" markdown="1" data-item-count="3" start="1" style="list-style-type: decimal;">
<li markdown="1" value="1">

<span class="math-inline">\\(\vec{0} \in S\\)</span>

</li>
<li markdown="1" value="2">

<span class="math-inline">\\(\vec{u}, \vec{v} \in S \rightarrow \vec{u} + \vec{v} \in S\\)</span>

</li>
<li markdown="1" value="3">

<span class="math-inline">\\(\vec{u} \in S, c \in \mathbb{R} \rightarrow c\vec{u} \in S\\)</span>
...
<img src="imgs/lab06-lines.jpg" alt="image" style="width: 50%; max-width: 100%;">
</div>
...
span all of <span class="math-inline">\\(S\\)</span>
...
These vectors span all of <span class="math-inline">\\(\mathbb{R}^5\\)</span>.
...
These vectors linearly independent.
...
Any 5 of these vectors span all of <span class="math-inline">\\(\mathbb{R}^5\\)</span>.
...
Let <span class="math-inline">\\(k\\)</span> be the dimension of the subspace spanned by a subset of 4 of these vectors. What are all possible values of <span class="math-inline">\\(k\\)</span>?

</li>
<li markdown="1" value="2">

Let <span class="math-inline">\\(m\\)</span> be the dimension of the subspace spanned by a subset of 7 of these vectors. What are all possible values of <span class="math-inline">\\(m\\)</span>?
...
If we're choosing 4 of the 10 vectors, <span class="math-inline">\\(k\\)</span> must be between 1 and 4, inclusive.
...
If we're choosing 7 of the 10 vectors, <span class="math-inline">\\(m\\)</span> must be between 3 and 6, inclusive.
...
## Activity 3: Finding a Linearly Independent Subset
...
In each of the parts below, find **a linearly independent** set of vectors that spans the same span as the given set of vectors. There are multiple possible answers for each part.
...
## Activity 4: Finding Bases for Subspaces
...
<span class="math-inline">\\(x + 2y - 3z = 4\\)</span>

</li>
<li markdown="1" value="2">

<span class="math-inline">\\(\vec v\\)</span> is on the line <span class="math-inline">\\(L = \begin{bmatrix} 1 \\\\ -2 \\\\ 0 \end{bmatrix} + t \begin{bmatrix} 2 \\\\ 3 \\\\ 4 \end{bmatrix}, t \in \mathbb{R}\\)</span>

</li>
<li markdown="1" value="3">

<span class="math-inline">\\(x + y + z = 0\\)</span> and <span class="math-inline">\\(x - y + z = 1\\)</span>

</li>
<li markdown="1" value="4">

<span class="math-inline">\\(x = -z\\)</span> and <span class="math-inline">\\(x = z\\)</span>

</li>
<li markdown="1" value="5">

<span class="math-inline">\\(x^2 + y^2 = z\\)</span>
...
<span class="math-inline">\\(x^2 + y^2 = z\\)</span> is **not a subspace**. The zero vector is the set, since plugging in <span class="math-inline">\\((x, y, z) = (0, 0, 0)\\)</span> gives us <span class="math-inline">\\(0^2 + 0^2 = 0\\)</span>, which is fine. But, the set is not closed under scalar multiplication. For example, consider <span class="math-inline">\\(\begin{bmatrix} 3 \\\\ 4 \\\\ 25 \end{bmatrix}\\)</span>, which is in the set, but <span class="math-inline">\\(2 \begin{bmatrix} 3 \\\\ 4 \\\\ 25 \end{bmatrix} = \begin{bmatrix} 6 \\\\ 8 \\\\ 50 \end{bmatrix}\\)</span> is not in the set, since <span class="math-inline">\\(6^2 + 8^2 = 100 \neq 50\\)</span>.
...
## Activity 6: Finding Non-Examples of Subspaces
...
<div style="text-align: center;">
<img src="imgs/blank-axes.png" alt="image" style="width: 50%; max-width: 100%;">
</div>
